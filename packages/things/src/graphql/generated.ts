...
> = {
  createThing?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationcreateThingArgs, "title">
  >;
  updateThing?: Resolver<
    ResolversTypes["Thing"],
    ParentType,
    ContextType,
    RequireFields<MutationupdateThingArgs, "id">
  >;
  deleteThing?: Resolver<
    ResolversTypes["Thing"],
    ParentType,
    ContextType,
    RequireFields<MutationdeleteThingArgs, "id">
  >;
};
...
> {
  Thing?: {
    ...
    title?: LoaderResolver<Maybe<Scalars["String"]>, Thing, {}, TContext>;
    description?: LoaderResolver<Maybe<Scalars["String"]>, Thing, {}, TContext>;
    isDone?: LoaderResolver<Maybe<Scalars["Boolean"]>, Thing, {}, TContext>;
    until?: LoaderResolver<Maybe<Scalars["String"]>, Thing, {}, TContext>;
  };
}
